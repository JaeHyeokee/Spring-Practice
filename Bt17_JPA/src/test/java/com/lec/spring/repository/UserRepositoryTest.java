...
//        userRepository.delete(userRepository.findById(1L).orElse(null));
        ...
        // delete 는 null값 허용 안함.
//        userRepository.delete(userRepository.findById(1L).orElse(null));
        // 차라리 예외 발생하고 처리하도록 하는게 낳다.
...
//        userRepository.deleteAllInBatch();
        ...
        ExampleMatcher matcher = ExampleMatcher.matching()      // 검색조건
...
//        userRepository.findByName("martin").forEach(System.out::println);
    ...
    void qryMethod002() {
        ...
        System.out.println("findUsersByEmail : " + userRepository.findUsersByEmail(email));
    }
...
//        result.forEach(System.out::println);
    ...
    void embededTest1() {
        ...
        User user = new User();
        user.setName("유인아");
        user.setHomeAddress(new Address("서울", "구로구", "대림동 냥냥", "11111"));
    ...
    // embed 된 Address 값이 null 이라면 어케 되나?
    @Test
    void embededTest2() {

        User user1 = new User();
        user1.setName("유인아");
        user1.setHomeAddress(new Address("서울", "구로구", "대림동 냥냥", "11111"));
