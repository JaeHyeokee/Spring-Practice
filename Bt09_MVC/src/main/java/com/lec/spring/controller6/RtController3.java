...
public class RtController3 {
    ...
    public String mapTest3() {
        String url = "http://localhost:8080/server/1";  // 반.드.시 절대 경로 이어야 한다
    ...
    // 1. 상속받은 객체 사용
    // 2. JSON 배열은 List<> 나 Array 로 받을수 있다
    @RequestMapping("/mapTest4")
    public String mapTest4() {
        String url = "http://localhost:8080/server/2";  // 반.드.시 절대 경로 이어야 한다
    ...
    public String mapTest5() {
        String url = "http://localhost:8080/server/3";  // 반.드.시 절대 경로 이어야 한다
